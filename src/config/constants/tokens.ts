...
import babybakeABI from "../abi/babybake.json";
import babymaticABI from "../abi/babymatic.json";
...
const tokens = {
  ...
  babymatic: {
    symbol: "BABYMATIC",
    address: {
      56: "0xb2ce41b71d93d7f5878f985c3e1a87a6229019be",
      97: "",
    },
    projectLink: "https://babymatic.io/",
    image: babymaticLogo,
    abi: babymaticABI,
  ...
  babybake: {
    symbol: "BABYBAKE",
    address: {
      56: "0x4f73b1f7adcf65d0fa744fd49a8d0341f478cd24",
      97: "",
    },
    image: babybakeLogo,
  ...
  babydollar: {
    symbol: "BABYDOLLAR",
    address: {
      56: "0x4e833a1bdeeb75b3778cf1637a0af420786c3099",
      97: "",
    },
    projectLink: "https://babydollar.app/",
  ...
  babyuni: {
    symbol: "BABYUNI",
    address: {
      56: "0x4e7f41b1495f024668eff303dcec76389a636da1",
      97: "",
    },
    projectLink: "https://www.babyuni.io/",
    image: babyuniLogo,
    abi: babyuniABI,
  ...
  checoin: {
    symbol: "CHECOIN",
    address: {
      56: "0x54626300818e5c5b44db0fcf45ba4943ca89a9e2",
      97: "",
    },
    projectLink: "https://launch.checoin.finance/",
    image: checoinLogo,
    abi: checoinABI,
    rewardImage: bnbLogo,
  ...
  nanodogecoin: {
    symbol: "NDC",
    address: {
      56: "0x1b41821625d8cfad21cd56491dacd57ecacc83de",
      97: "",
    },
    projectLink: "nanodogecoin.com",
    image: ndcLogo,
    abi: nanodogecoinABI,
...
export interface IDividendToken {
  symbol: string;
  address: {
    "56": string;
    "97": string;
