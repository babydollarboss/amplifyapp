...
const RoadmapBlock = styled(({ left, className, number, ...rest }) => (
  <div
...
const RoadmapRow = styled(({ className, done, description }) => (
  ...
  return (
    <RoadmapContainer className={!visible ? "hidden" : ""}>
      <RoadmapBlocksContainer>
        ...
        <RoadmapBlock number={2} left={true}>
        ...
        <RoadmapBlock number={4} left={true}>
